                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="{{ route('fakultas.store') }}" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input value="{{$trainer->nama}}" type="text" class="form-control" name="nama_fakultas" placeholder="Nama Fakultas">
                      @error('nama_fakultas')
                    ...
                    <div class="form-group">
                      ...
                      <input value="{{$trainer->nama}}" type="text" class="form-control" name="nama_dekan" placeholder="Nama Dekan">
                      @error('nama_dekan')
                              <span class="text-danger">{{ $message }}</span>
                      @enderror
                    </div>
